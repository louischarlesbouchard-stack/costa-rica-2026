...
# Keep J1 to J9
for i in range(1, 10):
    new_iti[f'J{i}'] = iti[f'J{i}']

# Map J11 to J10, ..., J21 to J20
for i in range(11, 22):
    if f'J{i}' in iti:
        new_iti[f'J{i-1}'] = iti[f'J{i}']
...
replacement = """let days = [
  ...
  // DRAKE BAY - 2 Days (via Sierpe boat)
  {
  ...
  {
    d: 'J12', date: '1 Août', loc: 'Santa Teresa', title: 'Surf & Chill', photos: [photoDB.santa_teresa[3], photoDB.santa_teresa[4], photoDB.santa_teresa[5]], coords: [9.6453, -85.1666], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/santa-teresa/114986/weather-forecast/114986",
  ...
  // SÁMARA - 3 Days
  {
    d: 'J13', date: '2 Août', loc: 'Sámara', title: 'Route Côtière', photos: photoDB.samara, coords: [9.8805, -85.5269], travel: "4h • 140 km", road: "Route 160", roadType: "secondary",
  ...
  {
    d: 'J14', date: '3 Août', loc: 'Sámara', title: 'Isla Tortuga', photos: [photoDB.samara[5], photoDB.samara[6], photoDB.samara[7]], coords: [9.8805, -85.5269], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/samara/113645/weather-forecast/113645",
  ...
  {
    d: 'J15', date: '4 Août', loc: 'Sámara', title: 'Nosara & Plages', photos: [photoDB.samara[0], photoDB.samara[1], photoDB.samara[2]], coords: [9.8805, -85.5269], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/samara/113645/weather-forecast/113645",
  ...
  // TAMARINDO - 3 Days
  {
    d: 'J16', date: '5 Août', loc: 'Tamarindo', title: 'Route Côtière', photos: photoDB.tamarindo, coords: [10.2993, -85.8400], travel: "2h30 • 85 km", road: "Route 160", roadType: "secondary",
  ...
  {
    d: 'J17', date: '6 Août', loc: 'Tamarindo', title: 'Playa Grande', photos: [photoDB.tamarindo[3], photoDB.tamarindo[4], photoDB.tamarindo[5]], coords: [10.2993, -85.8400], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/tamarindo/113650/weather-forecast/113650",
  ...
  {
    d: 'J18', date: '7 Août', loc: 'Tamarindo', title: 'Détente Finale', photos: [photoDB.tamarindo[0], photoDB.tamarindo[1], photoDB.tamarindo[2]], coords: [10.2993, -85.8400], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/tamarindo/113650/weather-forecast/113650",
  ...
  // CURUBANDÉ - 1 Day
  {
    d: 'J19', date: '8 Août', loc: 'Curubandé', labelPos: 'top', title: 'La Leona', photos: photoDB.laleona, coords: [10.7650, -85.3900], travel: "1h45 • 80 km", road: "Route 21", roadType: "highway",
  ...
  // LIBERIA - Departure
  {
    d: 'J20', date: '9 Août', loc: 'Liberia', labelPos: 'right', title: 'Vol Retour', photos: photoDB.liberia, coords: [10.6346, -85.4410], travel: "30 min • 25 km", road: "Route 1", roadType: "highway",
    weatherUrl: "https://www.accuweather.com/en/cr/liberia/113626/weather-forecast/113626",
