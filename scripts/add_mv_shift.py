...
# Insert J3 (La Fortuna)
j3_templ = copy.deepcopy(iti['J2'])
j3_templ['activities'] = []
j3_templ['restaurants'] = []
j3_templ['expenses'] = {k: 0 for k in j3_templ['expenses']}
new_iti['J3'] = j3_templ

# Insert J4 (Monteverde)
j4_templ = copy.deepcopy(j3_templ)
new_iti['J4'] = j4_templ
...
for i in range(3, 20):
    ...
    new_key = f'J{i+2}'
    if old_key in iti:
        new_iti[new_key] = iti[old_key]

data['itinerary'] = new_iti
...
# We need to replace the days array.
# Let's cleanly inject the 21 days array.
replacement = """let days = [
  // LA FORTUNA - 3 Days
  {
  ...
  {
    d: 'J3', date: '23 Juil', loc: 'La Fortuna', labelPos: 'bottom', title: 'Détente & Découverte', photos: [photoDB.arenal[0], photoDB.arenal[1], photoDB.arenal[2]], coords: [10.4709, -84.6453], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/la-fortuna/112660/weather-forecast/112660",
    text: "• Journée supplémentaire à La Fortuna<br>• Baignade, balade ou repos<br>• Exploration libre des environs"
  },

  // MONTEVERDE - 1 Day
  {
    d: 'J4', date: '24 Juil', loc: 'Monteverde', title: 'Cloud Forest', photos: [], coords: [10.3168, -84.8252], travel: "3h • 115 km", road: "Route 142 + 606", roadType: "secondary",
    weatherUrl: "https://www.accuweather.com/en/cr/monteverde/113642/weather-forecast/113642",
    text: "• Route vers Monteverde<br>• Randonnée dans la forêt de nuages<br>• Réserva Biológica Bosque Nuboso ou Selvatura Park"
  },
  ...
  {
    d: 'J7', date: '27 Juil', loc: 'Uvita', title: 'Plages & Détente', photos: [photoDB.uvita[0], photoDB.uvita[1], photoDB.uvita[5]], coords: [9.1670, -83.7441], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/uvita/114995/weather-forecast/114995",
  ...
  {
    d: 'J8', date: '28 Juil', loc: 'Drake Bay', title: 'Vers Drake Bay', photos: photoDB.corcovado, coords: [8.6917, -83.6644], travel: "2h • 60 km", road: "Route 243", roadType: "secondary",
  ...
  {
    d: 'J9', date: '29 Juil', loc: 'Drake Bay', title: 'Corcovado', photos: [photoDB.corcovado[3], photoDB.corcovado[4], photoDB.corcovado[5]], coords: [8.6917, -83.6644], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/bahia-drake/114952/weather-forecast/114952",
  ...
  {
    d: 'J10', date: '30 Juil', loc: 'Drake Bay', title: 'Isla del Caño', photos: [photoDB.corcovado[0], photoDB.corcovado[1], photoDB.corcovado[2]], coords: [8.6917, -83.6644], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/bahia-drake/114952/weather-forecast/114952",
  ...
  {
    d: 'J11', date: '31 Juil', loc: 'Santa Teresa', title: 'Grande Traversée', photos: photoDB.santa_teresa, coords: [9.6453, -85.1666], travel: "6h • 260 km", road: "Route 34 + 21", roadType: "highway",
  ...
  {
    d: 'J12', date: '1 Août', loc: 'Santa Teresa', title: 'Montezuma Day', photos: photoDB.montezuma, coords: [9.6453, -85.1666], travel: "45min aller", road: "Piste", roadType: "secondary",
    weatherUrl: "https://www.accuweather.com/en/cr/santa-teresa/114986/weather-forecast/114986",
  ...
  {
    d: 'J13', date: '2 Août', loc: 'Santa Teresa', title: 'Surf & Chill', photos: [photoDB.santa_teresa[3], photoDB.santa_teresa[4], photoDB.santa_teresa[5]], coords: [9.6453, -85.1666], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/santa-teresa/114986/weather-forecast/114986",
  ...
  // SÁMARA - 3 Days
  {
    d: 'J14', date: '3 Août', loc: 'Sámara', title: 'Route Côtière', photos: photoDB.samara, coords: [9.8805, -85.5269], travel: "4h • 140 km", road: "Route 160", roadType: "secondary",
  ...
  {
    d: 'J15', date: '4 Août', loc: 'Sámara', title: 'Isla Tortuga', photos: [photoDB.samara[5], photoDB.samara[6], photoDB.samara[7]], coords: [9.8805, -85.5269], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/samara/113645/weather-forecast/113645",
  ...
  {
    d: 'J16', date: '5 Août', loc: 'Sámara', title: 'Nosara & Plages', photos: [photoDB.samara[0], photoDB.samara[1], photoDB.samara[2]], coords: [9.8805, -85.5269], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/samara/113645/weather-forecast/113645",
  ...
  // TAMARINDO - 3 Days
  {
    d: 'J17', date: '6 Août', loc: 'Tamarindo', title: 'Route Côtière', photos: photoDB.tamarindo, coords: [10.2993, -85.8400], travel: "2h30 • 85 km", road: "Route 160", roadType: "secondary",
  ...
  {
    d: 'J18', date: '7 Août', loc: 'Tamarindo', title: 'Playa Grande', photos: [photoDB.tamarindo[3], photoDB.tamarindo[4], photoDB.tamarindo[5]], coords: [10.2993, -85.8400], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/tamarindo/113650/weather-forecast/113650",
  ...
  {
    d: 'J19', date: '8 Août', loc: 'Tamarindo', title: 'Détente Finale', photos: [photoDB.tamarindo[0], photoDB.tamarindo[1], photoDB.tamarindo[2]], coords: [10.2993, -85.8400], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/tamarindo/113650/weather-forecast/113650",
  ...
  // CURUBANDÉ - 1 Day
  {
    d: 'J20', date: '9 Août', loc: 'Curubandé', labelPos: 'top', title: 'La Leona', photos: photoDB.laleona, coords: [10.7650, -85.3900], travel: "1h45 • 80 km", road: "Route 21", roadType: "highway",
  ...
  // LIBERIA - Departure
  {
    d: 'J21', date: '10 Août', loc: 'Liberia', labelPos: 'right', title: 'Vol Retour', photos: photoDB.liberia, coords: [10.6346, -85.4410], travel: "30 min • 25 km", road: "Route 1", roadType: "highway",
    weatherUrl: "https://www.accuweather.com/en/cr/liberia/113626/weather-forecast/113626",
