...
with open('original_budget.json', 'r', encoding='utf-16') as f:
    orig = json.load(f)

new_data = copy.deepcopy(orig)
# We will rebuild the itinerary from scratch
new_iti = {}

orig_iti = orig['itinerary']

# J1, J2: La Fortuna
new_iti['J1'] = orig_iti['J1']
new_iti['J2'] = orig_iti['J2']

# J3: La Fortuna (new)
j3_templ = copy.deepcopy(orig_iti['J2'])
j3_templ['activities'] = []
...
# J4: Monteverde (new)
new_iti['J4'] = copy.deepcopy(j3_templ)

# J5, J6: Uvita (were originally J3, J4)
new_iti['J5'] = orig_iti['J3']
new_iti['J6'] = orig_iti['J4']

# J7, J8, J9: Drake Bay (were originally J6, J7, J8)
new_iti['J7'] = orig_iti['J6']
new_iti['J8'] = orig_iti['J7']
new_iti['J9'] = orig_iti['J8']

# J10, J11: Santa Teresa (were originally J9, J10)
new_iti['J10'] = orig_iti['J9']
new_iti['J11'] = orig_iti['J10']

# J12, J13, J14: Samara (were originally J12, J13, J14)
new_iti['J12'] = orig_iti['J12']
new_iti['J13'] = orig_iti['J13']
new_iti['J14'] = orig_iti['J14']

# J15, J16, J17: Tamarindo (were originally J15, J16, J17)
new_iti['J15'] = orig_iti['J15']
new_iti['J16'] = orig_iti['J16']
new_iti['J17'] = orig_iti['J17']

# J18: Curubande (was originally J18)
new_iti['J18'] = orig_iti['J18']

# J19: Liberia (was originally J19)
new_iti['J19'] = orig_iti['J19']

new_data['itinerary'] = new_iti
...
replacement = """let days = [
  ...
  {
    d: 'J7', date: '27 Juil', loc: 'Drake Bay', title: 'Vers Drake Bay', photos: photoDB.corcovado, coords: [8.6917, -83.6644], travel: "2h • 60 km", road: "Route 243", roadType: "secondary",
  ...
  {
    d: 'J8', date: '28 Juil', loc: 'Drake Bay', title: 'Corcovado', photos: [photoDB.corcovado[3], photoDB.corcovado[4], photoDB.corcovado[5]], coords: [8.6917, -83.6644], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/bahia-drake/114952/weather-forecast/114952",
  ...
  {
    d: 'J9', date: '29 Juil', loc: 'Drake Bay', title: 'Isla del Caño', photos: [photoDB.corcovado[0], photoDB.corcovado[1], photoDB.corcovado[2]], coords: [8.6917, -83.6644], travel: "Sur Place",
    weatherUrl: "https://www.accuweather.com/en/cr/bahia-drake/114952/weather-forecast/114952",
